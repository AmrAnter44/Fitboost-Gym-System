/**
 * Phone number normalization for WhatsApp (Electron sidecar / CommonJS).
 *
 * ⚠️ IMPORTANT: This logic is MIRRORED from `lib/phoneNormalize.ts`.
 * The Electron build (`package.json` build.files) ships `electron/**` but NOT
 * `lib/**`, so the sidecar can't import the TS version. Keep both in sync.
 *
...
module.exports = { toWhatsAppNumber, toWhatsAppJid };
