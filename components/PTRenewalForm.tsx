        ...
        if (result.receipt) {
          try {
            ...
            if (receiptResponse.ok) {
              ...
              // If fetch fails, still call onSuccess after delay
              setTimeout(() => {
                onSuccess()
                onClose()
              }, 1500)
          ...
          // No receipt returned, close after delay
          setTimeout(() => {
            onSuccess()
            onClose()
          }, 1500)
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-y-auto">
        <div className="bg-gradient-to-r from-green-600 to-green-700 text-white p-4 rounded-t-2xl">
          <div className="flex justify-between items-center">
            <div>
              <h2 className="text-xl font-bold mb-1">🔄 {t('pt.renewal.title')}</h2>
        ...
        <div className="p-4">
          ...
          {/* PT Packages Section */}
          <div className="bg-gradient-to-br from-primary-50 to-primary-50 dark:from-gray-700 dark:to-gray-700 border-2 border-primary-200 dark:border-gray-600 rounded-xl p-4 mb-4 dark:text-white">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2">
                {packages.map(pkg => (
                  <button
                    ...
                    className="bg-white dark:bg-gray-800 border-2 border-primary-300 dark:border-primary-700 hover:border-primary-500 hover:bg-primary-50 dark:hover:bg-primary-900/30 rounded-xl p-3 transition transform hover:scale-105 hover:shadow-lg group"
                  >
            ...
            <div className={`mt-3 bg-primary-100 dark:bg-primary-900/30 p-2 rounded ${direction === 'rtl' ? 'border-r-4' : 'border-l-4'} border-primary-500 dark:border-primary-700`}>
              <p className="text-xs text-primary-800 dark:text-primary-300">
                <strong>💡 ملاحظة:</strong> يمكنك تعديل البيانات بعد اختيار الباقة
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border-2 rounded-lg text-sm dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                  ...
                  {coachesLoading ? (
                    ...
                    <div className="space-y-1">
                      <input
                        ...
                        className="w-full px-3 py-2 border-2 border-gray-300 dark:border-gray-600 rounded-lg text-sm dark:border-gray-600 dark:bg-gray-700 dark:text-white"
              ...
              <div className="mt-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border-2 border-green-400 rounded-lg text-sm font-bold dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                    placeholder="0.00"
                  />
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <div className="bg-gradient-to-br from-primary-50 to-pink-50 dark:from-gray-700 dark:to-gray-700 border-2 border-primary-200 dark:border-gray-600 rounded-xl p-4 dark:text-white">
                ...
                <div className="grid grid-cols-2 gap-3 mb-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border-2 rounded-lg font-mono text-sm dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                ...
                <div className="mb-3">
                  <p className="text-xs font-medium mb-2">⚡ {t('pt.quickAdd')}</p>
