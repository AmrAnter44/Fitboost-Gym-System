      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-y-auto">
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-4 rounded-t-2xl">
          <div className="flex justify-between items-center">
            <div>
              <h2 className="text-xl font-bold mb-1">🔄 {t('physiotherapy.renewal.title')}</h2>
        ...
        <div className="p-4">
          ...
          <div className="bg-blue-50 border-l-4 border-r-4 border-blue-500 p-3 rounded-lg mb-4 dark:bg-blue-900/20 dark:border-blue-700">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="mt-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border-2 border-blue-400 rounded-lg text-sm font-bold dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                    placeholder="0.00"
                  />
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <div className="bg-gradient-to-br from-blue-50 to-pink-50 border-2 border-blue-200 rounded-xl p-4 dark:border-gray-600 dark:bg-gray-700 dark:text-white">
                ...
                <div className="mb-3">
                  <p className="text-xs font-medium mb-2">⚡ {t('physiotherapy.quickAdd')}</p>
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 bg-blue-600 text-white py-2.5 px-6 rounded-lg hover:bg-blue-700 disabled:bg-gray-400 transition font-bold text-base"
              >
