    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4" dir={direction}>
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-4">
          ...
          {/* Packages Section */}
          <div className="bg-gradient-to-br from-lime-50 to-green-100 dark:from-gray-700 dark:to-gray-700 border-2 border-lime-400 dark:border-gray-600 rounded-xl p-4 mb-4 dark:text-white">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                {packages.map(pkg => (
                  <button
                    ...
                    className="bg-white dark:bg-gray-800 hover:bg-lime-50 dark:hover:bg-green-900/30 border-2 border-lime-300 dark:border-lime-700 hover:border-lime-500 rounded-xl p-3 transition transform hover:scale-105 hover:shadow-lg"
                  >
          ...
          <div className="bg-green-50 border-l-4 border-r-4 border-green-500 p-3 rounded-lg mb-4 dark:bg-green-900/20 dark:border-green-700">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="bg-gradient-to-br from-green-50 to-primary-50 dark:from-gray-700 dark:to-gray-700 border-2 border-green-200 dark:border-gray-600 rounded-xl p-4 dark:text-white">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border-2 rounded-lg dark:border-gray-600 dark:bg-gray-700 dark:text-white text-sm"
                  ...
                  {coachesLoading ? (
                    ...
                    <div className="space-y-1">
                      <input
                        ...
                        className="w-full px-3 py-2 border-2 border-gray-300 dark:border-gray-600 rounded-lg dark:border-gray-600 dark:bg-gray-700 dark:text-white text-sm"
              ...
              <div className="mt-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border-2 border-green-400 rounded-lg dark:border-gray-600 dark:bg-gray-700 dark:text-white text-sm font-bold"
                    placeholder="0.00"
                  />
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <div className="bg-gradient-to-br from-green-50 to-pink-50 dark:from-gray-700 dark:to-gray-700 border-2 border-green-200 dark:border-gray-600 rounded-xl p-4 dark:text-white">
                <h3 className="font-bold text-base mb-3 flex items-center gap-2">
                  <span>📅</span>
                ...
                <div className="grid grid-cols-2 gap-3 mb-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border-2 rounded-lg dark:border-gray-600 dark:bg-gray-700 dark:text-white font-mono text-sm"
                  ...
                  <div className="flex flex-wrap gap-2">
                    {[1, 2, 3, 6, 9, 12].map(months => (
                      <button
                        ...
                        className="px-2 py-1 bg-green-100 dark:bg-green-900/30 hover:bg-green-200 dark:hover:bg-green-800/40 text-green-800 dark:text-green-300 rounded-lg text-xs transition font-medium"
                      >
                ...
                {duration !== null && formData.expiryDate && (
                  <div className="bg-white dark:bg-gray-800 border-2 border-green-300 dark:border-green-700 rounded-lg p-2">
                    {duration > 0 ? (
              ...
              <div className="space-y-4">
                <div className="bg-gradient-to-br from-green-50 to-green-50 dark:from-gray-700 dark:to-gray-700 border-2 border-green-200 dark:border-gray-600 rounded-xl p-4 dark:text-white">
                ...
                <div className="bg-gradient-to-br from-yellow-50 to-orange-50 dark:from-gray-700 dark:to-gray-700 border-2 border-yellow-200 dark:border-gray-600 rounded-xl p-4 dark:text-white">
                  ...
                  <div className="space-y-2">
                    <div className="bg-green-50 dark:bg-green-900/20 border-l-4 border-r-4 border-green-400 dark:border-green-700 p-2 rounded">
                    ...
                    <div className="bg-green-100 dark:bg-green-900/20 border-l-4 border-r-4 border-green-500 dark:border-green-700 p-2 rounded">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                onClick={onClose}
                disabled={loading}
                className="px-6 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200 py-2.5 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition font-medium text-base"
              >
