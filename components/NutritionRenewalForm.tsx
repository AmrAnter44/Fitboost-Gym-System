...
export default function NutritionRenewalForm({ session, onSuccess, onClose }: NutritionRenewalFormProps) {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="nutrition-renewal-title"
    >
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg ring-1 ring-gray-200 dark:ring-gray-700 max-w-6xl w-full max-h-[90vh] overflow-y-auto">
        <div className="bg-green-600 text-white p-4 rounded-t-2xl">
          <div className="flex justify-between items-center">
            <div>
              <h2 id="nutrition-renewal-title" className="text-xl font-bold mb-1 flex items-center gap-2">
                <svg className="w-6 h-6" {...stroke}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99" />
                </svg>
                <span>{t('nutrition.renewal.title')}</span>
              </h2>
            ...
            <button
              ...
              aria-label={t('nutrition.cancelButton')}
            >
        ...
        <div className="p-4">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm ring-1 ring-green-200 dark:ring-green-900/50 p-5 mb-4">
            <h3 className="font-bold text-lg mb-3 flex items-center gap-2 text-green-800 dark:text-green-300">
              <svg className="w-6 h-6" {...stroke}>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                {packages.map(pkg => (
                  <button
                    ...
                    className="bg-white dark:bg-gray-800 hover:bg-green-50 dark:hover:bg-green-900/20 ring-1 ring-green-300 dark:ring-green-900/50 hover:ring-green-500 rounded-xl p-3 transition-colors duration-200"
                  >
          ...
          <div className={`bg-green-50 dark:bg-green-900/20 ${direction === 'rtl' ? 'border-e-4' : 'border-s-4'} border-green-500 dark:border-green-700 p-3 rounded-lg mb-4`}>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div>
                <p className="text-xs text-gray-600 dark:text-gray-400">{t('nutrition.renewal.nutritionNumber')}</p>
                <p className="text-xl font-bold text-green-600 dark:text-green-400">#{session.nutritionNumber}</p>
              </div>
              <div>
                <p className="text-xs text-gray-600 dark:text-gray-400">{t('nutrition.renewal.clientName')}</p>
                <p className="text-base font-bold text-gray-900 dark:text-gray-100">{session.clientName}</p>
              </div>
              <div>
                <p className="text-xs text-gray-600 dark:text-gray-400">{t('nutrition.renewal.currentNutritionist')}</p>
                <p className="text-base text-gray-900 dark:text-gray-100">{session.nutritionistName}</p>
              </div>
              <div>
                <p className="text-xs text-gray-600 dark:text-gray-400">{t('nutrition.renewal.currentSessionsRemaining')}</p>
            ...
            {(session.remainingAmount || 0) > 0 && (
              <div className="mt-2 pt-2 border-t border-green-200 dark:border-green-900/50">
                <div className="bg-orange-100 dark:bg-orange-900/30 ring-1 ring-orange-300 dark:ring-orange-900/50 rounded-lg p-2 flex items-center justify-between">
                  ...
                  <span className="text-base font-bold text-orange-600 dark:text-orange-400">{(session.remainingAmount || 0).toFixed(0)} {t('nutrition.egp')}</span>
                </div>
              </div>
            )}
            ...
            {session.expiryDate && (
              <div className="mt-2 pt-2 border-t border-green-200 dark:border-green-900/50">
                <p className="text-xs text-gray-600 dark:text-gray-400 inline-block">{t('nutrition.renewal.currentExpiryDate')}: </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm ring-1 ring-green-200 dark:ring-green-900/50 p-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                <div>
                  <label htmlFor="nutrition-renew-phone" className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1.5">
                    {t('nutrition.phoneNumber')}
                  </label>
                  <input
                    id="nutrition-renew-phone"
                    type="tel"
                ...
                <div>
                  <label htmlFor="nutrition-renew-sessions" className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1.5">
                    {t('nutrition.renewal.newSessionsCount')} <span className="text-red-600">*</span>
                  </label>
                  <input
                    id="nutrition-renew-sessions"
                    type="number"
                    required
                    min="1"
                ...
                <div>
                  <label htmlFor="nutrition-renew-nutritionist" className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1.5">
                  ...
                  {coachesLoading ? (
                    ...
                    <div className="space-y-1">
                      <input
                        id="nutrition-renew-nutritionist"
                        type="text"
                        required
                      ...
                      <p className="text-xs text-amber-600 dark:text-amber-400 flex items-center gap-1">
                        ...
                        <span>{t('nutrition.noActiveNutritionists')}</span>
                      </p>
                    </div>
                  ) : (
                    <select
              ...
              <div className="mt-3">
                <div>
                  <label htmlFor="nutrition-renew-price" className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1.5">
                    {t('nutrition.renewal.totalAmount')} <span className="text-red-600">*</span>
                  </label>
                  <input
                    id="nutrition-renew-price"
                    type="number"
                    required
                    min="0"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm ring-1 ring-green-200 dark:ring-green-900/50 p-5">
                ...
                <div className="grid grid-cols-2 gap-3 mb-3">
                  <div>
                    <label htmlFor="nutrition-renew-start" className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1.5">
                      {t('nutrition.startDate')} <span className="text-red-600">*</span>
                    </label>
                    <input
                      id="nutrition-renew-start"
                      type="text"
                      required
                  ...
                  <div>
                    <label htmlFor="nutrition-renew-expiry" className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1.5">
                      {t('nutrition.expiryDate')} <span className="text-red-600">*</span>
                    </label>
                    <input
                      id="nutrition-renew-expiry"
                      type="text"
                      required
                ...
                <div className="mb-3">
                  <p className="text-xs font-bold mb-2 text-gray-700 dark:text-gray-300">{t('nutrition.quickAdd')}</p>
                  <div className="flex flex-wrap gap-2">
                    {[1, 2, 3, 6, 9, 12].map(months => (
                      <button
                        ...
                        className="px-2.5 py-1 bg-green-100 dark:bg-green-900/30 hover:bg-green-200 dark:hover:bg-green-800/40 text-green-800 dark:text-green-300 rounded-lg text-xs font-bold transition-colors duration-200"
                      >
                ...
                {duration !== null && formData.expiryDate && (
                  <div className="bg-green-50 dark:bg-green-900/20 ring-1 ring-green-200 dark:ring-green-900/50 rounded-lg p-2">
                    {duration > 0 ? (
                      <div className="flex items-center gap-2">
                        <svg className="w-5 h-5 text-green-600 dark:text-green-400" {...stroke}>
                          <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <div>
                          <p className="font-bold text-green-800 dark:text-green-300 text-xs">{t('nutrition.renewal.subscriptionDuration')}</p>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm ring-1 ring-yellow-200 dark:ring-yellow-900/50 p-5">
                  ...
                  <div className="space-y-2">
                    <div className={`bg-green-50 dark:bg-green-900/20 ${direction === 'rtl' ? 'border-e-4' : 'border-s-4'} border-green-400 dark:border-green-700 p-2 rounded`}>
                      <p className="text-xs text-green-800 dark:text-green-300">
                        {t('nutrition.renewal.replacementWarning', {
                          sessionsRemaining: session.sessionsRemaining.toString()
                        })}
                      </p>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-600 dark:text-gray-400">{t('nutrition.renewal.newSessionsLabel')}</span>
                      <span className="font-bold text-green-600 dark:text-green-400">{formData.sessionsPurchased} {t('nutrition.session')}</span>
                    </div>
                    <div className={`bg-green-100 dark:bg-green-900/20 ${direction === 'rtl' ? 'border-e-4' : 'border-s-4'} border-green-500 dark:border-green-700 p-2 rounded`}>
                      <div className="flex justify-between">
                        <span className="font-bold text-gray-900 dark:text-gray-100 text-sm">{t('nutrition.renewal.paidAmount')}</span>
                        <span className="font-bold text-green-600 dark:text-green-400 text-base">{formData.totalPrice} {t('nutrition.egp')}</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 bg-green-600 hover:bg-green-700 text-white font-bold px-4 py-2.5 rounded-lg transition-colors duration-200 disabled:opacity-60 disabled:cursor-not-allowed"
              >
