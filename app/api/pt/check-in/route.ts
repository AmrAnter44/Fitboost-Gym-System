// app/api/pt/check-in/route.ts - تسجيل حضور العضو باستخدام Barcode
...
/**
 * POST - تسجيل حضور العضو بـ Barcode/رقم PT (بدون authentication)
 *
 * الأمان:
 * - لا يحتاج تسجيل دخول (صفحة عامة للعضو)
 * - Barcode (رقم PT) هو المصادقة الوحيدة
