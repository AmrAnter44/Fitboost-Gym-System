...
export async function POST(request: Request) {
  try {
    // ✅ تجديد Physiotherapy متاح لأي موظف مسجّل دخول (مش الكوتش)
    ...
    try {
      ...
      logError({ error: receiptError, endpoint: '/api/physiotherapy/renew', method: 'POST', statusCode: 200, additionalContext: { type: 'receipt_creation_failed' } })
      return NextResponse.json({
        physiotherapy: updatedPhysiotherapy,
    ...
    logError({ error, endpoint: '/api/physiotherapy/renew', method: 'POST', statusCode: 500 })
