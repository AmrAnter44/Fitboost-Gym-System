...
interface NutritionistEarnings {
  ...
  totalRevenue: number
  serviceRevenue: number  //  تحصيل الخدمات فقط (التغذية) بدون قيمة الجلسات المجانية — يطابق كارت التارجت
  clients: number
}
...
export default function NutritionCommissionPage() {
  ...
  const calculateNutritionistEarnings = (nutritionistName: string, startDate: string, endDate: string): NutritionistEarnings => {
    ...
    return {
      ...
      remainingSessions,
      totalRevenue,
      serviceRevenue: nutritionRevenue,  //  تحصيل التغذية بس (بدون قيمة الجلسات المجانية) — للجدول عشان يطابق الكارت
      clients,
    }
  }
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-4 sm:p-6">
          ...
          {loading ? (
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              {/* جدول النسب - فقط في طريقة الإيرادات (مخفي لما التارجت المنفصل ON) */}
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  {(() => {
                    ...
                    if (freeSessionsDetails.count > 0) {
                      return (
                        <div className="bg-gradient-to-br from-lime-50 to-green-50 dark:from-lime-900/30 dark:to-green-900/30 ring-1 ring-lime-300 dark:ring-lime-600 rounded-xl p-3 sm:p-4">
      ...
      {calculationMethod === 'sessions' && (
        <div className="mt-6">
          <div className="bg-gradient-to-br from-green-50 to-teal-50 dark:from-green-900/50 dark:to-teal-900/50 ring-1 ring-green-300 dark:ring-green-700 rounded-xl shadow-lg p-6 dark:border-gray-600 dark:bg-gray-700 dark:text-white">
            ...
            {loadingSessionData ? (
              <LoadingScreen message={t('nutrition.commission.calculatingCommission')} />
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg ring-1 ring-gray-200 dark:ring-gray-600">
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                  <div className="bg-green-50 dark:bg-green-900/50 p-4 rounded-lg ring-1 ring-green-200 dark:ring-green-700">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-3 ring-1 ring-green-300 dark:ring-green-600 rounded-lg text-lg font-mono focus:border-green-500 focus:ring-2 focus:ring-green-200 dark:bg-gray-700 dark:text-white"
                        placeholder="25"
                      />
                  ...
                  <div className="bg-blue-50 dark:bg-blue-900/50 p-4 rounded-lg ring-1 ring-blue-200 dark:ring-blue-700">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-3 ring-1 ring-blue-300 dark:ring-blue-600 rounded-lg text-lg font-mono focus:border-blue-500 focus:ring-2 focus:ring-blue-200 dark:bg-gray-700 dark:text-white"
                        placeholder="30"
                      />
                  ...
                  <div className="bg-yellow-50 dark:bg-yellow-900/50 p-4 rounded-lg ring-1 ring-yellow-200 dark:ring-yellow-700">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-3 ring-1 ring-yellow-300 dark:ring-yellow-600 rounded-lg text-lg font-mono focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200 dark:bg-gray-700 dark:text-white"
                        placeholder="35"
                      />
                  ...
                  <div className="bg-orange-50 dark:bg-orange-900/50 p-4 rounded-lg ring-1 ring-orange-200 dark:ring-orange-700">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-3 ring-1 ring-orange-300 dark:ring-orange-600 rounded-lg text-lg font-mono focus:border-orange-500 focus:ring-2 focus:ring-orange-200 dark:bg-gray-700 dark:text-white"
                        placeholder="40"
                      />
                  ...
                  <div className="bg-red-50 dark:bg-red-900/50 p-4 rounded-lg ring-1 ring-red-200 dark:ring-red-700">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-3 ring-1 ring-red-300 dark:ring-red-600 rounded-lg text-lg font-mono focus:border-red-500 focus:ring-2 focus:ring-red-200 dark:bg-gray-700 dark:text-white"
                        placeholder="45"
                      />
